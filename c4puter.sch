...
F27 "PCI_SDA" B L 5200 5300 50 
F28 "PCI_SCL" B L 5200 5200 50 
F29 "~PRSNT1_[0..3]" I L 5200 4800 50 
F30 "~PRSNT2_[0..3]" I L 5200 4900 50 
F31 "~PCIRST" O L 5200 5000 50 
F32 "~PCIPME" I L 5200 5100 50 
F33 "PCIM66EN" I L 5200 5400 50 
F34 "RS232_TX" O L 5200 6300 50 
F35 "RS232_RX" I L 5200 6400 50 
F36 "RS232_RTS" O L 5200 6500 50 
F37 "RS232_CTS" I L 5200 6600 50 
F38 "USB_VBUS" I L 5200 6800 50 
F39 "XUSB_D-" B L 5200 6900 50 
F40 "XUSB_D+" B L 5200 7000 50 
$EndSheet
Wire Wire Line
	7400 4600 6900 4600
Wire Wire Line
...
Wire Wire Line
	4600 500  12500 500 
Wire Wire Line
	12500 500  12500 1700
Wire Wire Line
	12500 1700 11900 1700
Wire Wire Line
	5200 5200 4700 5200
Wire Wire Line
	4700 5200 4700 600 
...
Wire Bus Line
	5100 4800 5100 1000
Wire Bus Line
	5100 1000 12000 1000
Wire Bus Line
	12000 1000 12000 1200
Wire Bus Line
	12000 1200 11900 1200
Wire Bus Line
	5200 4900 5000 4900
Wire Bus Line
	5000 4900 5000 900 
...
Wire Wire Line
	4800 700  12300 700 
Wire Wire Line
	12300 700  12300 1500
Wire Wire Line
	12300 1500 11900 1500
Wire Wire Line
	5200 5000 4900 5000
Wire Wire Line
	4900 5000 4900 800 
...
F 0 "J10" H 1219 4245 50  0000 L CNN
F 1 "RS232" H 1219 4154 50  0000 L CNN
...
AR Path="/57A95B42" Ref="#PWR?"  Part="1" 
...
F 0 "J8" H 1277 3920 50  0000 L CNN
F 1 "DEBUG" H 1277 3829 50  0000 L CNN
F 2 "conn-fci:CONN-10118194-0001LF-FCI" H 1100 3900 50  0001 C CNN
F 3 "" H 1000 4100 50  0000 C CNN
F 4 "DIST DIGIKEY 609-4618-1-ND" H 1600 4800 50  0001 C CNN "BOM"
	1    1100 3900
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 57AA9ABF
P 1300 2900
F 0 "SW3" H 1300 3167 50  0000 C CNN
F 1 "SW-DIP-4" H 1300 3076 50  0000 C CNN
F 2 "dip-sip:DIP-8" H 1300 2400 50  0001 C CNN
...
AR Path="/57AA9AC6" Ref="#PWR?"  Part="1" 
F 0 "#PWR?" H 900 3300 30  0001 C CNN
F 1 "GND" H 900 3230 30  0001 C CNN
